...
class ResortsApi {
  ...
  Future<Map<String, dynamic>> getResortDetail(String resortId) async {
    final response = await _dio.get<dynamic>('/resorts/$resortId');
    return response.data as Map<String, dynamic>;
  }

  Future<List<Map<String, dynamic>>> listFavoriteResorts() async {
    final response = await _dio.get<dynamic>('/users/me/favorites');
  ...
  Future<Map<String, dynamic>> addFavorite(String resortId) async {
    final response = await _dio.post<dynamic>('/users/me/favorites/$resortId');
    return response.data as Map<String, dynamic>;
  }
